...
SwapChainSupportDetails SwapChainUtils::QuerySwapChainSupport(VkPhysicalDevice device, VkSurfaceKHR surface)
{
...
VkExtent2D SwapChainUtils::ChooseSwapExtent(Window* window, const VkSurfaceCapabilitiesKHR& capabilities)
{
